...
const renderChart = function(chartType, bindToId, data, showLegend) {
  const ctx = document.getElementById(bindToId).getContext('2d');
  const config = getChartJsConfig(chartType, data, showLegend);
